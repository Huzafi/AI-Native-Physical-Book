...
class QueryService:
    ...
    def create_query(self, db: Session, query_data: QueryBase) -> Query:
        ...
        try:
            ...
            db.rollback()
            logger.error(f"Database error creating query: {str(e)}")
            raise
        except Exception as e:
            db.rollback()
            logger.error(f"Unexpected error creating query: {str(e)}")
            raise
    ...
    def get_query(self, db: Session, query_id: str) -> Optional[Query]:
        ...
        try:
            ...
            logger.error(f"Database error getting query: {str(e)}")
            raise
        except Exception as e:
            logger.error(f"Unexpected error getting query: {str(e)}")
            raise
    ...
    def create_response(self, db: Session, query_id: str, response_data: dict) -> Response:
        ...
        try:
            ...
            db.rollback()
            logger.error(f"Unexpected error creating response: {str(e)}")
            raise
    ...
    def get_response(self, db: Session, response_id: str) -> Optional[Response]:
        ...
        try:
            ...
            logger.error(f"Database error getting response: {str(e)}")
            raise
        except Exception as e:
            logger.error(f"Unexpected error getting response: {str(e)}")
            raise
    ...
    def get_response_by_query(self, db: Session, query_id: str) -> Optional[Response]:
        ...
        try:
            ...
            logger.error(f"Database error getting response by query: {str(e)}")
            raise
        except Exception as e:
            logger.error(f"Unexpected error getting response by query: {str(e)}")
            raise
